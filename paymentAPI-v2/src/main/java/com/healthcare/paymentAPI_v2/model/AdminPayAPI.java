 ...
 */
@WebServlet("/AdminPayAPI")
public class AdminPayAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = paymentObj.insertPayment(request.getParameter("docID"), request.getParameter("hospitalID"),
				request.getParameter("patientID"), request.getParameter("amount"), request.getParameter("appointmentID"), request.getParameter("paymentStatus"));
