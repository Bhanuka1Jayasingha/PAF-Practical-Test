 ...
 */
@WebServlet("/CcardAPI")
public class CcardAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = cardObj.insertCreditCardInfo(request.getParameter("cardNo"), request.getParameter("cvv"),
				request.getParameter("ccHolderName"), request.getParameter("ccExpDate"), request.getParameter("paymentID"));
