...
<body >
	<div style="text-align: center;position:relative;left:250px;top:50px;" class="container">
		<div class="row">
			<div style="background-color:#6ABAEC;height:600px;border-radius:10px;" class="col-6">
				<h1>Add Payment</h1>
				...
				<br>
				<a href="Ccard.jsp"><input type="button" value="Add Card Details" class="btn btn-primary"></a>
				<br>
			</div>
		</div>
	</div>
